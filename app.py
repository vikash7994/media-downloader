...
def downloadyt():       
   ...
   #  video_file = requests.get(download_link)
   ...
   #      file.write(video_file.content)
    # Send the video file as a direct download
   #  return send_file(io.BytesIO(video_file.content), as_attachment=True, attachment_filename=filename)
